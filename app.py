...
# ИСПРАВЛЕННЫЕ ModelView для админки - ТЕПЕРЬ КНОПКА CREATE РАБОТАЕТ!
class CarModelView(ModelView):
    ...
    form_widget_args = {
        'description': {'rows': 5},
        'photo_url': {'placeholder': 'https://example.com/photo.jpg'}
    }
...
class ManagerModelView(ModelView):
    ...
    form_widget_args = {
        'name': {'placeholder': 'Имя менеджера'},
        'telegram_username': {'placeholder': '@username без @'}
    }
...
class PriceCategoryModelView(ModelView):
    ...
    form_widget_args = {
        'name': {'placeholder': '0-3000$'},
        'min_price_usd': {'placeholder': '0'},
        'max_price_usd': {'placeholder': '3000'}
    }
...
class UserModelView(ModelView):
    ...
    form_widget_args = {
        ...
        'telegram_id': {'placeholder': '1234567890'}
    }
...
# TELEGRAM БОТ - работает как есть
def telegram_bot():
